...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ablation-token-batch-size", type=int, default=128)
    parser.add_argument("--ablation-neuron-batch-size", type=int, default=96)
    parser.add_argument("--fisher-tokens", type=int, default=512)
    parser.add_argument("--fisher-token-batch-size", type=int, default=16)
    parser.add_argument("--fisher-neuron-batch-size", type=int, default=32)
